...
FileAttachment("artist-1@3.csv").csv()
)}
...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>占此問卷的多數的前三名分別是工作室的藝術工作者(38.8%)、替代空間(18.5%)、非營利組織/藝術團體(14.8%)</li>
    <li>藝術品拍賣的藝術工作者占此問卷的最少數(0.195%)</li>
    <li>節能減碳措施: 問卷中顯示了大多數的人在工作場所和活動展場實施節約能源和減少碳排放的措施，如減少包裝材和文宣印製，這進一步表明藝術界對於永續發展的承諾。</li>
  </ul>
</h3>`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artist-1@3.csv", {url: new URL("../artist.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
