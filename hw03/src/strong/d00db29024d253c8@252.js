...
(width, height, offsetX, offsetY, scale) => {
  ...
  details
    ...
    .append("path")
    .attr("fill", (d) => {
      const townData = minidata.find(
        (t) =>
          t.value === d.properties.COUNTYNAME ||
          t["value"].replace("臺", "台") === d.properties.COUNTYNAME
      );
      return townData ? thresholdScale(townData.count) : thresholdScale(0);
    })
    .attr("stroke", "gray")
    .attr("d", path)
    .append("title")
    .text((d) => {
      ...
      return `${d.properties.COUNTYNAME} ${townData ? townData.count : 0}人`;
    });
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["data.json", {url: new URL("./files/fed5f1d3a0c24bdf6439d72fa4d1f8c9aecb5246f11a4e48fda7bf4bfdd9f7f3ff06d0d681fd4bec26133ee1df46391b1b6b9edca5d581387b0575448cf0e50f.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
